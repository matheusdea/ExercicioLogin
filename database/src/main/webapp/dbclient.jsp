          ...
          <div class="panel panel-info">
            ...
            <div class="panel-body">
              <div class="row">
                ...
                <div class="col-sm-3">
                  <div class="form-group">
                    <%String login = val(request, "user");%>
                    <input type="text" name="user" class="form-control input-sm" placeholder="Usuário" value="<%=login%>">
                  </div>
                </div>
                <div class="col-sm-3">
                  <div class="form-group">
                    <%String pw = val(request, "password");%>
                    <input type="password" name="password" class="form-control input-sm" placeholder="Senha" value="<%=pw%>">
                  </div>
                </div>
                <div class="col-sm-2">
                  <div class="form-group">
